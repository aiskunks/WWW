          ...
          <div className="row">
            <div className="column small-12 large-6 medium-6">
              ...
              <div className="page-section--slider__info">
                <h2>
                  AI Now Launches “Regulating Biometrics: Global Approaches and
                  Open Questions”
                </h2>
        ...
        >
          <div className="row">
            ...
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  Kate Crawford, Amba Kak, and Jason Schultz submitted comments
                  to the Australian Human Rights Commission’s extensive
                  proposals on a human rights framework for artificial
                  intelligence.
                </p>
                <div className="link">
        ...
        >
          <div className="row">
            ...
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  Amba Kak and Rashida Richardson submitted comments to Canada’s
                  Office of the Privacy Commission responding to proposals for
                  ensuring appropriate regulation for artificial intelligence.
                </p>
                <div className="link">
        ...
        >
          <div className="row">
            ...
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  AI Now submitted an amicus curiae brief in support of the ACLU
                  of Pennsylvania and in opposition of the Special Master's
                  recommendation for Philadelphia to develop and use a pre-trial
                  risk assessment to improve bail decisionmaking.
                </p>
                <div className="link">
            ...
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  ...
                  Committee on Technology on the urgency to address and regulate
                  City agency use of Automated Decision Systems. Read the full
                  testimony here.
                </p>
                <div className="link">
            ...
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  ...
                  for transparency around the existence and use of surveillance
                  technology by NYPD. Read the full written testimony.
                </p>
                <div className="link">
            ...
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  ...
                  of facial and affect recognition. We also look at the growing
                  movements that are demanding a h...
                </p>
                <div className="link">
          ...
          <div className="row">
            <div className="column small-12 large-6 medium-6">
              ...
              <div className="page-section--slider__info">
                ...
                <p>
                  A Shadow Report of the New York City Automated Decision System
                  Task Force
                </p>
              </div>
            </div>
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  ...
                  community powered shadow report that provides a comprehensive
                  record of the Task Force’s community engagemen...
                </p>
                <div className="link">
            ...
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  ...
                  taken so seriously. Sarah Myers West examines the latest in a
                  string of examples that illustrate why AI doesn’t work for
                  everyone.
                </p>
                <div className="link">
            ...
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  ...
                  AI, draws from a wealth of research from disability advocates
                  and scholars, and examines what d...
                </p>
                <div className="link">
        ...
        >
          <div className="row">
            ...
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  AI Now, NYU Law's Center on Race, Inequality, and the Law, and
                  other scholars submitted the following comments to the US
                  Department on Housing and Urban Development regarding its
        ...
        >
          <div className="row">
            ...
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  AI Now Co-Founders Kate Crawford and Meredith Whittaker kicked
                  off our 2019 Symposium by recapping the critical moments and
                  people who defined a growing movement that is pushing back
                  against harmful AI technologies and systems.
                </p>
                <div className="link">
        ...
        >
          <div className="row">
            ...
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  AI Now is hiring postdoctoral researchers whose work resonates
                  with the Institute's mission. We welcome applications across a
            ...
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  ...
                  S.1876/H.2701, which creates a Commission on government use of
                  automated decision-making and artificial intelligence systems.
                </p>
                <div className="link">
        ...
        >
          <div className="row">
            ...
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  After an extensive search, we’re thrilled to share that Andrea
                  Nill Sánchez will join the AI Now Leadership Team as Executive
                  Director.
                </p>
                <div className="link">
            ...
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  ...
                  Director of Global Strategy and Programs. Meet Amba and other
                  members of our newly expanded team.
                </p>
                <div className="link">
            ...
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  ...
                  year, we’re providing behind-the-scenes insights from those at
                  the frontlines of the growing pushback against harmful AI.
                  Tickets will become available on August 26th.
                </p>
                <div className="link">
                  <a href="https://symposium.ainowinstitute.org/">Learn More</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="column small-12 large-6 medium-6">
              ...
              <div className="page-section--slider__info">
                ...
                <p>Driving forward our work on Gender, Race, and Power in AI</p>
              </div>
            </div>
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  ...
                  develop AI Now’s strategy and programs related to AI, Gender,
                  Race, and Power research.
                </p>
                <div className="link">
            ...
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  ...
                  Leadership Team at this exciting moment in our organization’s
                  growth. The ED will have overall strategic and operational
                  responsibility for AI Now’s staff, programs, funding, and
          ...
          <div className="row">
            <div className="column small-12 large-6 medium-6">
              ...
              <div className="page-section--slider__info">
                ...
                <p>
                  Written Testimony to the US House Committee on Science, Space,
                  and Technology
                </p>
              </div>
            </div>
            <div className="column">
              <div className="page-section--slider__announcement">
                <p>
                  ...
                  Space and Technology on the societal and ethical implications
                  of AI. Read the full written testimony.
                </p>
                <div className="link">
