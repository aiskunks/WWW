        ...
        <div className="row ">
          <div className="column medium-12 small-12">
            <div className="page-section--cards-sm__card">
              ...
              <p>
                As artificial intelligence and related technologies are used to
                make determinations and predictions in high stakes domains such
                as criminal justice, law enforcement, housing, hiring, and
                education, they have the potential to impact basic rights and
                liberties in profound ways. AI Now is partnering with the ACLU
                and other stakeholders to better understand and address these
                impacts.
              </p>
            </div>
          </div>
          <div className="column medium-12 small-12">
            <div className="page-section--cards-sm__card">
              ...
              <p>
                Automation and early-stage artificial intelligence systems are
                already changing the nature of employment and working conditions
                in multiple sectors. AI Now works with social scientists,
                economists, labor organizers, and others to better understand
                AI's implications for labor and work – examining who benefits
                and who bears the cost of these rapid changes.
              </p>
            </div>
          </div>
          <div className="column medium-12 small-12">
            <div className="page-section--cards-sm__card">
              ...
              <p>
                ...
                which it was created. Artificial intelligence systems ‘learn’
                based on the data they are given. This, along with many other
                factors, can lead to biased, inaccurate, and unfair outcomes. AI
                Now researches issues of fairness, looking at how bias is
                defined and by whom, and the different impacts of AI and related
                technologies on diverse populations.
              </p>
            </div>
          </div>
          <div className="column medium-12 small-12">
            <div className="page-section--cards-sm__card">
              ...
              <p>
                As artificial intelligence systems are introduced into our core
                infrastructures, from hospitals to the power grid, the risks
                posed by errors and blind spots increase. AI Now studies the
                ways in which AI and related technologies are being applied
                within these domains and aims to understand possibilities for
      ...
      <div className="page-section page-section--subscribe">
        <div className="row expanded">
          <div className="column large-7">
            <p>
              We're new, but our work is underway. Sign up for our mailing list
              and follow us on Twitter to stay in touch.
            </p>
            <form
